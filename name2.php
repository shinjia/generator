...
// 產生名字 (女生)
$username1 = $a_last[array_rand($a_last,1)];
$username1 .= $a_firstf[array_rand($a_firstf,1)];
$username1 .= $a_firstf[array_rand($a_firstf,1)];


// 產生名字 (男生)
$username2 = $a_last[array_rand($a_last,1)];
$username2 .= $a_firstm[array_rand($a_firstm,1)];
$username2 .= $a_firstm[array_rand($a_firstm,1)];
