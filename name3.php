...
{
   // 產生名字 (女生)
   $username = $a_last[array_rand($a_last,1)];
   $username .= $a_firstf[array_rand($a_firstf,1)];
   $username .= $a_firstf[array_rand($a_firstf,1)];
}
else
{
   // 產生名字 (男生)
   $username = $a_last[array_rand($a_last,1)];
   $username .= $a_firstm[array_rand($a_firstm,1)];
   $username .= $a_firstm[array_rand($a_firstm,1)];
}
